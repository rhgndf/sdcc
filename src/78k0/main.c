...
k78k0_genInitStartup (FILE *of)
{
  ...
  fprintf (of, "\tmovw\tax,sp\n");
  fprintf (of, "\tsubw\tax,#0x0006\n");
  fprintf (of, "\tmovw\tsp,ax\n");
  fprintf (of, "\tmovw\thl,ax\n");
  fprintf (of, "\tmovw\tax,#s_DATA\n");
  fprintf (of, "\tmov\ta,x\n");
  fprintf (of, "\tmov\t[hl+0x00],a\n");
  fprintf (of, "\tmovw\tax,#s_DATA\n");
  fprintf (of, "\tmov\t[hl+0x01],a\n");
  fprintf (of, "\tmovw\tax,#l_DATA\n");
  fprintf (of, "\tmov\ta,x\n");
  fprintf (of, "\tmov\t[hl+0x02],a\n");
  fprintf (of, "\tmovw\tax,#l_DATA\n");
  fprintf (of, "\tmov\t[hl+0x03],a\n");
  fprintf (of, "00003$:\n");
  fprintf (of, "\tmovw\tax,sp\n");
  fprintf (of, "\tmovw\thl,ax\n");
  fprintf (of, "\tmov\ta,[hl+0x02]\n");
  fprintf (of, "\tor\ta,[hl+0x03]\n");
  fprintf (of, "\tbz\t00004$\n");
  fprintf (of, "\tmov\ta,[hl+0x00]\n");
  fprintf (of, "\tmov\tx,a\n");
  fprintf (of, "\tmov\ta,[hl+0x01]\n");
  fprintf (of, "\tmovw\thl,ax\n");
  ...
  fprintf (of, "\tmovw\thl,ax\n");
  fprintf (of, "\tmov\ta,[hl+0x00]\n");
  fprintf (of, "\tadd\ta,#0x01\n");
  fprintf (of, "\tmov\t[hl+0x00],a\n");
  fprintf (of, "\tmov\ta,[hl+0x01]\n");
  fprintf (of, "\taddc\ta,#0x00\n");
  fprintf (of, "\tmov\t[hl+0x01],a\n");
  fprintf (of, "\tmov\ta,[hl+0x02]\n");
  fprintf (of, "\tsub\ta,#0x01\n");
  fprintf (of, "\tmov\t[hl+0x02],a\n");
  fprintf (of, "\tmov\ta,[hl+0x03]\n");
  fprintf (of, "\tsubc\ta,#0x00\n");
  fprintf (of, "\tmov\t[hl+0x03],a\n");
  fprintf (of, "\tbr\t!00003$\n");
  fprintf (of, "00004$:\n");
  fprintf (of, "\tmovw\tax,sp\n");
  fprintf (of, "\tmovw\thl,ax\n");
  fprintf (of, "\tmovw\tax,#s_INITIALIZER\n");
  fprintf (of, "\tmov\ta,x\n");
  fprintf (of, "\tmov\t[hl+0x00],a\n");
  fprintf (of, "\tmovw\tax,#s_INITIALIZER\n");
  fprintf (of, "\tmov\t[hl+0x01],a\n");
  fprintf (of, "\tmovw\tax,#s_INITIALIZED\n");
  fprintf (of, "\tmov\ta,x\n");
  fprintf (of, "\tmov\t[hl+0x02],a\n");
  fprintf (of, "\tmovw\tax,#s_INITIALIZED\n");
  fprintf (of, "\tmov\t[hl+0x03],a\n");
  fprintf (of, "\tmovw\tax,#l_INITIALIZER\n");
  fprintf (of, "\tmov\ta,x\n");
  fprintf (of, "\tmov\t[hl+0x04],a\n");
  fprintf (of, "\tmovw\tax,#l_INITIALIZER\n");
  fprintf (of, "\tmov\t[hl+0x05],a\n");
  fprintf (of, "00001$:\n");
  fprintf (of, "\tmovw\tax,sp\n");
  fprintf (of, "\tmovw\thl,ax\n");
  fprintf (of, "\tmov\ta,[hl+0x04]\n");
  fprintf (of, "\tor\ta,[hl+0x05]\n");
  fprintf (of, "\tbz\t00002$\n");
  fprintf (of, "\tmov\ta,[hl+0x00]\n");
  fprintf (of, "\tmov\tx,a\n");
  fprintf (of, "\tmov\ta,[hl+0x01]\n");
  ...
  fprintf (of, "\tsub\ta,#0x01\n");
  fprintf (of, "\tmov\t[hl+0x04],a\n");
  fprintf (of, "\tmov\ta,[hl+0x05]\n");
  fprintf (of, "\tsubc\ta,#0x00\n");
  fprintf (of, "\tmov\t[hl+0x05],a\n");
  fprintf (of, "\tbr\t!00001$\n");
  fprintf (of, "00002$:\n");
  fprintf (of, "\tmovw\tax,sp\n");
  fprintf (of, "\taddw\tax,#0x0006\n");
  fprintf (of, "\tmovw\tsp,ax\n");
}
